...
{
  if((letterCount <= max_letters - 1) && letters != NULL)  {
...
{
    if (letters != NULL) {
      delete [] letters; //Changed delete type to array
      letters = NULL;
    }
}
...
void Room::copy(const Room& other)
{
    ...
    letters = new Letter[max_letters];//added these lines to make a deep copy
